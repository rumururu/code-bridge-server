...
"""
    ...
    def api_host(self) -> str:
        """API server bind host. Defaults to 0.0.0.0 for external access."""
        return self._get_server_value("api_host", "0.0.0.0")

    @property
    def dashboard_host(self) -> str:
        """Dashboard server bind host. Defaults to 127.0.0.1 (localhost only)."""
        return self._get_server_value("dashboard_host", "127.0.0.1")
