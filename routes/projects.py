...
async def start_dev_server(name: str) -> dict[str, Any] | JSONResponse:
...
async def stop_dev_server(name: str) -> dict[str, Any] | JSONResponse:
...
async def restart_dev_server(name: str) -> dict[str, Any] | JSONResponse:
...
async def run_project_on_device(name: str, request: DeviceRunRequest) -> dict[str, Any] | JSONResponse:
